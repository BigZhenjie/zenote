...
const PageSquare = ({
  ...
  return (
    <button 
      className="relative w-36 min-h-36 rounded-2xl border-[1px] hover:border-gray-300 hover:shadow-sm"
      onClick={handleClick}
    >
      ...
      <p className="text-gray-400 mt-4 w-4/5 text-sm truncate text-center">
        {title}
      </p>
